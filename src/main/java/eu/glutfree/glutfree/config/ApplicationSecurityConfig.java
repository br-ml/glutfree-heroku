...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                antMatchers("/roles/delete", "/roles/add", "/food/add", "/food/delete/*", "/food/edit/*", "/receipt/add", "/receipt/delete/*", "/feedback/add", "/feedback/delete/*", "/users/delete", "/users/delete/*").hasRole("ADMIN").
